"""Dave’s HT4 electronic press kit — text documents for the ModYu asset hub."""

from __future__ import annotations


def join(*chunks: str) -> str:
    return "\n\n".join(c.strip() for c in chunks if c and c.strip()) + "\n"


def modyu_docs() -> list[tuple[str, str]]:
    return [
        (
            "Our story",
            join(
        ...
        (
            "HT4 boilerplate",
            join(
                "HT4 is a clinic-led, four-phase aftercare system designed specifically for people undergoing hair transplant surgery.",
        ...
        (
            ...
            join(
                ...
                "A global, billion-dollar procedure with no universally adopted standard for what happens after the operation. The surgery has been redesigned from first principles, more than once.",
                "~$4.5bn — Estimated value of the global hair-restoration surgery market in 2021.",
                "~628,600 — Hair-transplant procedures the ISHRS estimated were performed worldwide in 2021 — the most recent year it published a global total.",
                "85%/15% — Male-to-female split of surgical patients in 2024 (84.7% / 15.3%), with the female share up from 12.7% in 2021.",
                "91.7% — Share of donor grafts taken from the scalp, with FUE now the dominant harvesting method.",
                "No.1 — The most common reason patients gave for surgery was “to feel more attractive”; 44% said they planned to tell others they’d had a transplant.",
                "Source: ISHRS 2025 Practice Census",
            ),
        ),
        (
            "Pitch — A hair transplant is surgery",
            join(
                "Hair transplant head wounds",
                "A Hair Transplant Is Surgery. Why Don’t We Treat the Recovery Like It Is?",
                "You’ve just had hair transplant surgery. What should actually go on your scalp for the first 48 hours?",
                ...
                "Best for\n\nHealth and consumer-health desks. This is genuine service journalism, and HT4 need not be the hero of paragraph one.",
                ...
                "Ask\n\nWe’ll walk you through exactly what the guidance says — and what it doesn’t — and provide the evidence.",
            ),
        ),
        (
            "Pitch — The surgery became an artform",
            join(
                "Surgery to salt water",
                "The Surgery Became an Artform. The Aftercare Never Did.",
                ...
                "Best for\n\nFeatures, business and national desks.",
                ...
                "Ask\n\n“Why has aftercare lagged so far behind the surgery itself?” Put it to our founder — and, where possible, a partner surgeon.",
            ),
        ),
        (
            "Pitch — Your shampoo won’t grow your hair",
            join(
                "Miracle shampoos",
                "Your Shampoo Won’t Grow Your Hair. It’s Time Someone Said So.",
                ...
                "Best for\n\nFeatures, consumer-affairs and business desks.",
                ...
                "Ask\n\n“Why build a brand around what your product can’t do?”",
            ),
        ),
        (
            "Pitch — The most planned day, the least planned weeks",
            join(
                "Shock and itch — the days and weeks post transplant",
                "The Most Planned Day of Your Life. The Least Planned Weeks.",
                ...
                "Ask\n\nFollow one patient through the first ten days. We can make introductions, with consent.",
            ),
        ),
        (
            "Founder — Ann-Marie Barlow",
            join(
                "A hairdresser’s story",
                "The hairdresser who asked what happens after the surgery",
                "“I didn’t set out to make another shampoo. I set out to answer a question I couldn’t let go of.”",
                ...
                "A woman redefining an industry built for men, by men.",
        ...
        (
            ...
            join(
                ...
                "To arrange a comment or interview, see Contact. We aim to respond to media enquiries quickly.",
            ),
        ),
        (
            "Further angles",
        ...
        (
            ...
            join(
                ...
                "Phase 1 · Balance — Prepare\n\nUsed in roughly the thirty days before surgery. A gentle daily shampoo whose real purpose is preparation: arriving at the procedure with a calm, clean, comfortable scalp, and with the patient already feeling engaged and in control.",
                "Phase 2 · Cleanse — Protect\n\nThe first days after surgery, when the priority is simply to follow the clinic’s instructions. A sterile, CE-marked saline wound-cleanse, delivered as a fine mist that can be applied from any angle without touching the scalp, and sterile from the first spray to the last. Its early, frequent, gentle use is aligned with the principle that minimising crust supports a cleaner passage through the days grafts are most vulnerable.",
                "Phase 3 · Hydrate, Bathe & Comfort — Recover\n\nThree products because early recovery has three distinct needs: a moisture-balancing Hydrate spray, a light Bathe cleansing foam that lifts debris without rubbing, and an overnight Comfort serum for soothing and nourishment. They work together, never as alternatives.",
                "Phase 4 · Protect & Nourish — Continue\n\nRecovery doesn’t end when the visible signs fade. A shampoo and conditioner for long-term scalp and hair care that carry the healthy habits of recovery into everyday life. A transplant is one day; looking after your scalp is for life.",
        ...
        (
            ...
            join(
                ...
                "“The hair loss industry is full of ever-bigger promises. I’d rather HT4 be known for the opposite — telling patients honestly what our products can do, and what they can’t.”\n— Ann-Marie Barlow, Founder",
                "Please attribute testing to the independent laboratories, and the wound-healing and anchoring science to the authors and journals named. Full study summaries are available to accredited media on request, and we’re happy to have a scientific summary fact-checked before you publish.",
            ),
        ),
        (
            "Quote bank",
            join(
                "Quote bank",
                "All quotes: Ann-Marie Barlow, Founder of ModYu. Cleared for publication.",
                "The industry\n\n“The surgery has been redesigned from first principles, over and over. For years, the aftercare was the part nobody had gone back and designed properly.”\n\n“The surgery keeps getting more medical. The way we talk about it keeps getting less.”\n\n“As a hairdresser, I’d reached for baby shampoo to lift colour out of hair. So I could never quite understand how it became the thing we put on a healing scalp. Gentle isn’t the same as right.”",
                "On patients\n\n“The first seventy-two hours at home are when patients are most anxious and most alone. That’s exactly when the guidance has tended to be weakest.”\n\n“It still amazes me that someone will spend a fortnight reading a Facebook thread before their surgery, but won’t put the same question to the surgeon. That isn’t the patient’s failing — it’s a sign of how casual we’ve all let this feel. It’s surgery. Those questions deserve a professional, not a poll.”\n\n“We can’t make your hair grow. We can take scalp care seriously.”\n\n“A transplant is one day. Looking after your scalp is for life.”",
                "The founder story\n\n“I didn’t set out to make another shampoo. I set out to answer a question I couldn’t let go of.”\n\n“I wasn’t looking for a product to invent. I found a problem I couldn’t stop thinking about.”\n\n“I grew up on the salon floor, and that’s where I learned that hair care is never just superficial. It is an emotional, deeply personal journey. When you look after your hair, you are looking after your life.”",
                "The science\n\n“I didn’t guess at the timings. I built the phases around the published science of when grafts anchor.”\n\n“We only promise what we genuinely believe our products can do. Claiming less is what makes everything else we say believable.”",
                "Clinics\n\n“The surgeon is always in charge. We’re there to support the recovery, never to replace their judgement.”\n\n“This was never about selling clinics a product. It was about giving them a consistent standard to hand their patients.”",
                "The salon\n\n“Wellbeing and style are completely interconnected — a healthy lifestyle reflects in healthier hair, and the salon is where that confidence is brought to life.”\n\n“The salon isn’t just a place you go for a trim; it’s a space of transformation, community, and ultimate client care. I wanted ModYu to capture that exact feeling — that uncompromising attention to detail and dedicated focus on the individual, making people feel entirely good about themselves from the scalp up.”\n\n“Hair transplantation is where surgery meets artistry, but the hair world has always been driven by incredible craftspeople.”",
            ),
        ),
        (
            "Fast facts",
            join(
                "Fast facts",
                "Company — modYu Limited trading as HT4. Registered in England and Wales.\nFounder — Ann-Marie Barlow\nProduct — HT4 — a clinic-led, four-phase hair transplant aftercare system\nStructure — 4 phases: Prepare, Protect, Recover, Continue\nDevelopment — Around three years of formulation, lab and dermatological work\nTesting — Independent HRIPT · non-comedogenic · CE-marked medical-device\nDesigned around — The published science of graft anchoring and wound-healing moisture balance\nLaunched — ISHRS World Congress, Berlin\nPipeline — Clinic interest across Spain, the Netherlands, Brazil and Mexico\nModel — B2B Clinic Partner Programme\nWebsite — modyu.com",
            ),
        ),
        (
            "FAQ",
            join(
                "Fast facts & FAQ",
                "What does HT4 stand for?\n\nThe four phases of the system: Balance (before surgery), Cleanse (the first days after), the three-part Recover phase (Hydrate, Bathe, Comfort), and Protect & Nourish for long-term care.",
                "Is it sold instead of the clinic’s own advice?\n\nNo. HT4 is designed to work alongside a clinic’s protocol, never to replace it. Patients always follow their surgeon’s guidance first.",
                "Why four phases instead of one product?\n\nBecause recovery is a process, not an event. The scalp needs different things before surgery, immediately after, during early healing and long-term — and no single product covers all of that.",
                "Isn’t the Phase 2 cleanse just the saline clinics already use?\n\nIt’s sterile 0.9% saline, but assessed and classified as a CE-marked medical device and delivered through a sealed system that stays sterile to the last spray. We describe the difference without overstating what saline can do.",
                "Does it help hair grow?\n\nNo, and we never claim it does. HT4 supports the comfort, cleanliness and condition of the scalp through recovery and beyond. Growth is a matter of the surgery and the patient’s own biology.",
            ),
        ),
        (
            "About ModYu",
            join(
                ...
                "The whole hair experience\n\nModYu views hair through a holistic lens where wellbeing and style are entirely interconnected. Hair health does not exist in a vacuum; a healthy, balanced lifestyle is the foundation of vibrant hair, and ModYu champions both as one complete experience.",
                "The passion for the salon\n\nDeeply rooted in the energy, community, and transformative power of the salon floor. ModYu is fiercely passionate about the professional salon environment, where hair care meets personal connection.",
                "Creativity and craftspersonship\n\nBuilt on a profound respect for the artistry of hair. From meticulous product formulation to the fine details of styling, ModYu celebrates the dedication, skill, and creative spark of true craftspeople.",
                "The ultimate standard of client care\n\nObsessed with the finer details. ModYu brings an uncompromising level of attention, luxury, and personalised care to the individual, ensuring everyone is empowered to live life feeling completely good about themselves.",
        ...
        (
            ...
            join(
                ...
                "Unfiltered patient journeys\n\nDeep, real-time engagement with real people navigating hair restoration. It captures the raw emotional reality, the vulnerability of surgery, and the psychological shift of reclaiming self-image.",
                "The expert collective\n\nDirect, straight-talking interviews with leading surgeons, clinicians, and industry insiders who pull back the curtain on the hair transplant sector.",
                "The lifestyle evolution\n\nA channel constantly expanding its horizons. While rooted in the transplant sector, the content is actively broadening into the wider world of hair health, professional styling, and modern salon culture.",
                "The real-time trend tracker\n\nTap into the live conversations, anxieties, and triumphs of a highly engaged community to spot shifting consumer behaviours before they hit the mainstream.",
                "The authority rolodex\n\nA curated roster of clinicians and patients who are prepared and comfortable speaking to the media.",
            ),
        ),
        (
            "Contact",
            join(
                "Contact",
                "Ann-Marie Barlow\nFounder, ModYu Ltd (HT4)\nannmarie.barlow@modyu.com\nhttps://modyu.com",
                ...
                "ModYu Ltd (trading as HT4) · Registered in England & Wales · modyu.com",
